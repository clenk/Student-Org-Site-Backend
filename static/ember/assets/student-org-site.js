...
define('student-org-site/controllers/about', ['exports', 'ember'], function (exports, _ember) {
...
define('student-org-site/models/orgabout', ['exports', 'ember-data'], function (exports, _emberData) {
	exports['default'] = _emberData['default'].Model.extend({
		about: _emberData['default'].attr('string')
	});
});
define('student-org-site/models/orgname', ['exports', 'ember-data'], function (exports, _emberData) {
  exports['default'] = _emberData['default'].Model.extend({
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        ...
        statements: [["content", "org.about", ["loc", [null, [6, 0], [6, 13]]]]],
        locals: ["org"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "orgAboutList", ["loc", [null, [5, 8], [5, 20]]]]], [], 0, null, ["loc", [null, [5, 0], [7, 9]]]]],
      locals: [],
      templates: [child0]
    };
  })());
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        var el3 = dom.createTextNode("    ");
        dom.appendChild(el2, el3);
        var el3 = dom.createComment("<input type=\"checkbox\" name=\"tags\" value={{tag.name}}> {{tag.name}}<br>");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("\n");
        dom.appendChild(el2, el3);
        var el3 = dom.createTextNode("  ");
...
define("student-org-site/templates/home", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    var child0 = (function () {
      return {
        meta: {
          ...
          "moduleName": "student-org-site/templates/home.hbs"
        },
        arity: 1,
        cachedFragment: null,
        hasRendered: false,
        ...
        statements: [["inline", "page-title", [], ["title", ["subexpr", "@mut", [["get", "org.name", ["loc", [null, [2, 19], [2, 27]]]]], [], []]], ["loc", [null, [2, 0], [2, 29]]]]],
        locals: ["org"],
        templates: []
      };
    })();
    var child1 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["content", "post.title", ["loc", [null, [21, 54], [21, 68]]]]],
          locals: [],
          templates: []
        };
      })();
      return {
        ...
        statements: [["inline", "date-formatter", ["DD", ["get", "post.datePublished", ["loc", [null, [17, 53], [17, 71]]]]], [], ["loc", [null, [17, 31], [17, 73]]]], ["inline", "date-formatter", ["MMMM", ["get", "post.datePublished", ["loc", [null, [18, 58], [18, 76]]]]], [], ["loc", [null, [18, 34], [18, 78]]]], ["block", "link-to", ["post", ["get", "post", ["loc", [null, [21, 48], [21, 52]]]]], [], 0, null, ["loc", [null, [21, 30], [21, 80]]]], ["content", "post.subtitle", ["loc", [null, [22, 33], [22, 50]]]], ["inline", "text-preview", [["get", "post.content", ["loc", [null, [23, 48], [23, 60]]]], 200, 250], [], ["loc", [null, [23, 33], [23, 70]]]], ["attribute", "src", ["get", "post.author.profileImageUrl", []]], ["content", "post.author.name", ["loc", [null, [26, 109], [26, 129]]]]],
        locals: ["post"],
        templates: [child0]
      };
    })();
    var child2 = (function () {
      return {
        ...
        statements: [["content", "event.title", ["loc", [null, [42, 31], [42, 46]]]], ["inline", "date-formatter", ["MMMM DD, YYYY", ["get", "event.start", ["loc", [null, [43, 63], [43, 74]]]]], [], ["loc", [null, [43, 30], [43, 76]]]]],
        locals: ["event"],
        templates: []
      };
    })();
    return {
      ...
      statements: [["block", "each", [["get", "orgNameList", ["loc", [null, [1, 8], [1, 19]]]]], [], 0, null, ["loc", [null, [1, 0], [3, 9]]]], ["block", "each", [["get", "sortedposts", ["loc", [null, [13, 11], [13, 22]]]]], [], 1, null, ["loc", [null, [13, 3], [32, 12]]]], ["block", "each", [["get", "eventlist", ["loc", [null, [40, 12], [40, 21]]]]], [], 2, null, ["loc", [null, [40, 4], [45, 13]]]], ["content", "outlet", ["loc", [null, [52, 0], [52, 10]]]]],
      locals: [],
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[7] = dom.createMorphAt(dom.childAt(element8, [1, 1]), 1, 1);
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    ...
    var child2 = (function () {
      var child0 = (function () {
        return {
          ...
          statements: [["content", "post.title", ["loc", [null, [86, 9], [86, 23]]]]],
          locals: [],
          templates: []
        };
      })();
      return {
        ...
        statements: [["block", "link-to", ["post", ["get", "post", ["loc", [null, [80, 25], [80, 29]]]]], ["class", "table-row"], 0, null, ["loc", [null, [80, 7], [88, 19]]]]],
        locals: ["post"],
        templates: [child0]
      };
    })();
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[3] = dom.createMorphAt(dom.childAt(element5, [3, 3, 1]), 1, 1);
...
if (!runningTests) {
  require("student-org-site/app")["default"].create({"API_HOST":"http://localhost:8000","name":"student-org-site","version":"0.0.0+c4e7c282","API_NAMESPACE":"api","API_ADD_TRAILING_SLASHES":true});
}
